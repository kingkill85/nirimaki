# btop theme. Rendered by qs-theme-set; verbatim from basecamp/omarchy
# default/themed/btop.theme.tpl. After first install, set
# `color_theme = "qs"` in ~/.config/btop/btop.conf once — btop persists
# the choice and `qs-theme-set` then just rewrites this file.
